...
<head>
  ...
  #downloadResultsBtn {
    ...
    padding: 2px 23px; /* Adjust the padding for both height and width */
    border-radius: 5px; /* Set border-radius for rounded corners */
    cursor: pointer;
    margin-right: 5px; /* * Set margin-right for spacing */
    margin-bottom: 10px
  }
...
<script>
  ...
  DataTableJQ(document).ready(function () {
    ...
    <body>
      ...
      <button id="downloadResultsBtn" onclick="downloadZip()">Download Results</button>
